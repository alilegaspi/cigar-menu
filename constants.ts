...
export const CIGARS_DATA: Cigar[] = [
  ...
  {
    id: 32,
    name: 'ANTONIO GIMENEZ CORONA',
    image: '/images/ANTONIO GIMENEZ CORONA.png',
    price: '₱1,200.00',
    origin: 'Philippines',
    profile: 'Mild - Medium',
    vitola: '5.5x46 Corona',
    wrapper: 'Indonesia',
    binder: 'Philippines',
    filler: 'Philippines',
    description: 'A wonderfully balanced corona, the Antonio Gimenez Corona offers a smooth, refined smoke with creamy cedar, toasted nuts, and a gentle sweetness. Crafted with Philippine filler and binder, it delivers a polished, easy-drinking profile that highlights the rich heritage of Filipino tobacco.',
  },
  {
    id: 33,
    name: 'ANTONIO GIMENEZ ROBUSTO',
    image: '/images/ANTONIO GIMENEZ ROBUSTO.png',
    price: '₱1,200.00',
    origin: 'Philippines',
    profile: 'Medium',
    vitola: '5x52 Robusto',
    ...
    binder: 'Philippines',
    filler: 'Philippines',
    description: 'The Antonio Gimenez Robusto is a medium-bodied Filipino puro with a rich, earthy core and smooth notes of spice, cocoa, and dried fruit. Its tight construction and even burn make it a staple choice for those who appreciate well-made Philippine cigars.',
  },
  {
    id: 34,
    name: 'FLOR DE FELIPINAS CORONA',
    image: '/images/FLOR DE FELIPINAS CORONA.png',
    price: '₱1,200.00',
    origin: 'Philippines',
    profile: 'Mild - Medium',
    vitola: '5.5x44 Corona',
    ...
    binder: 'Philippines',
    filler: 'Philippines',
    description: 'Classic and refined, the Flor de Felipinas Corona showcases the soft sweetness and herbal notes of Philippine-grown tobaccos. It is a graceful cigar with a delicate finish, ideal for those who prefer a lighter, nuanced smoke.',
  },
  {
    id: 35,
    name: 'INDEPENDENCIA 1898 CHURCHILL',
    image: '/images/INDEPENDENCIA 1898 CHURCHILL.png',
    price: '₱1,200.00',
    origin: 'Philippines',
    profile: 'Medium',
    vitola: '7x50 Churchill',
    ...
    binder: 'Philippines',
    filler: 'Philippines',
    description: 'A longer format for a proud Philippine brand, the Independencia 1898 Churchill offers a sophisticated smoking experience with cocoa, toasted oak, and a subtle black-pepper finish. Its generous length reveals steady development and a creamy mouthfeel from start to finish.',
  },
  {
    id: 36,
    name: 'INDEPENDENCIA CORONA',
    image: '/images/INDEPENDENCIA CORONA.png',
    price: '₱1,200.00',
    origin: 'Philippines',
    profile: 'Medium',
    vitola: '5.5x46 Corona',
    ...
    binder: 'Philippines',
    filler: 'Philippines',
    description: 'The Independencia Corona is a smooth, balanced corona offering vibrant notes of coffee, caramel, and toasted nuts. Its all-Filipino blend is crafted for an accessible yet flavorful smoke representing the best of Philippine cigar-making traditions.',
  }
  ,
  {
    id: 37,
    ...
    description: 'This unique blend of luxurious smokes displays the milder side of Cohiba\'s flavor profile. Carefully crafted in Cuba, the cigar starts with aged Brazilian long-fillers and select Dominican tobaccos, nestled within a lively Mexican San Andrés binder. For the first time, these exceptional tobaccos are wrapped in a beautiful, silky Ecuador Connecticut wrapper leaf. Expertly hand-rolled, the mellow and smooth smoke lasts over 50 minutes. Initial notes of cedar and spice are joined by an underlying creaminess in the first half. Each puff reveals new layers of flavor, constructing a refined mild-to-medium-bodied profile. Hints of nutmeg and citrus add vibrancy as white pepper delivers a velvety, complex finish. These super premium cigars deliver an unparalleled rich taste and smooth character unique to Cohiba.',
  },
  {
    id: 38,
    ...
    origin: 'Dominican Republic',
    profile: 'Mild - Medium',
    vitola: '5.5x52 Robusto',
    wrapper: 'Ecuador Connecticut',
    binder: 'Connecticut',
    filler: 'Dominican Republic / Peru',
    description: 'Part of the Zino Platinum Scepter series, this Grand Master vitola offers a zesty, sweet profile with notes of roasted nuts, cedar, and coffee for a harmonious smoke.',
  },
  {
    id: 39,
    ...
    origin: 'Dominican Republic',
    profile: 'Medium - Full',
    vitola: 'Robusto / Box-Pressed (5.38" x 52)',
    wrapper: 'Mexico (San Andrés)',
    binder: 'Ecuador Sumatra',
    filler: 'Dominican Republic / Nicaragua',
    description: 'Handmade at Tabacalera La Alianza, El Senador is a box-pressed, well-balanced cigar presenting rich notes of dark chocolate, roasted coffee, leather, and a smooth, sweet creaminess.',
  },
  {
    id: 40,
    ...
    binder: 'Nicaragua',
    filler: 'Dominican Republic / Nicaragua',
    description: 'A refined, elegant Montecristo White vitola offering creamy notes of vanilla and nuts with balanced spice and a velvety finish.',
  },
  {
    id: 41,
    ...
    vitola: '6.0" x 52 Toro',
    wrapper: 'Mexico (San Andrés Maduro)',
    binder: 'Dominican Republic',
    filler: 'Dominican Republic, Nicaragua',
    description: 'Handmade for Matt Booth\'s Room101, this Maduro Toro features dark Mexican San Andrés over Dominican binder and Dominican/Nicaraguan filler, presenting dark cocoa, espresso, sweet earth, and toasted oak.',
  },
  {
    id: 42,
    ...
    origin: 'Nicaragua',
    profile: 'Medium - Full',
    vitola: 'Duque (6.0" x 60)',
    wrapper: 'Mexico (San Andrés)',
    binder: 'Nicaragua',
    filler: 'Nicaragua',
    description: 'The Mi Amor Duque is a box-pressed, flavor-intensive cigar featuring an oily Mexican San Andrés wrapper with rich notes of dark chocolate, toasted espresso, and black pepper.',
  },
  {
    id: 43,
    ...
    filler: 'Dominican Republic / Nicaragua',
    description: 'Handcrafted in Honduras, the Punch Signature Robusto features an Ecuadorian Corojo wrapper over a Connecticut Habano binder and a Dominican/Nicaraguan filler. This full-bodied robusto delivers rich notes of cedar, roasted nuts, leather, and a balanced peppery spice, finishing with a smooth, lingering creaminess.',
  }
];
