...
export const CIGARS_DATA: Cigar[] = [
  ...
  ,
  {
    ...
    filler: 'Dominican Republic / Nicaragua',
    description: 'A luxurious Cohiba offering dressed in an Ecuadorian Corojo wrapper, delivering bold notes of dark chocolate, roasted coffee beans, and leather with a smooth, creamy finish.',
  },
  {
    id: 38,
